        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Instructions = table.Column<string>(type: "character varying(15000)", maxLength: 15000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DietaryPreferences = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeeklyRankingEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeeklyRankingEntries_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserMedals_AspNetUsers_AssignedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Ratings_Stars", "\"Stars\" >= 1 AND \"Stars\" <= 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_RecipeId_CreatedAtUtc",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recipes_AuthorId_CreatedAtUtc",
                table: "Recipes",
                columns: new[] { "AuthorId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Recipes_CreatedAtUtc",
                table: "Recipes",
                column: "CreatedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_UserMedals_AssignedByUserId",
                table: "UserMedals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeeklyRankingEntries_UserId",
                table: "WeeklyRankingEntries",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WeeklyRankingEntries_WeekStartDate_Position",
                table: "WeeklyRankingEntries",
                columns: new[] { "WeekStartDate", "Position" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WeeklyRankingEntries_WeekStartDate_UserId",
                table: "WeeklyRankingEntries",
